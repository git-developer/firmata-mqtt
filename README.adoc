...
|`FIRMATA_PINS`
|Comma-separated list of pin number with optional pin mode and detection strategy
...
+
  ...
  - Configure pin `2` as digital input with pullup (default)
